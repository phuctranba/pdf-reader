...
public class RecentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeSort = MySharedPreferences.getPrefSortRecent(this);
        typeView = MySharedPreferences.getPrefViewRecent(this);
    ...
    protected void onStart() {
        pdfDocmnts.clear();
        pdfDocmnts.addAll(databaseHelper.getAllPDFDocRecent());
        setupGUI();
    ...
    private void init() {
        ...
        pdfDocmnts = databaseHelper.getAllPDFDocRecent();
        ...
        mPdfViewAdapter = new PdfRecyclerAdapter(this, pdfDocmnts,"RECENT",typeView, typeSort);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        itemClear.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(RecentActivity.this);

                View alert = LayoutInflater.from(RecentActivity.this).inflate(R.layout.dialog_yesno,null);
                ...
                btnYes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        dialog.dismiss();
                        databaseHelper.clearPDFDocRecent();
                        pdfDocmnts.clear();
                        mPdfViewAdapter.notifyDataSetChanged();
                    }
                });
    ...
    public void changeViewType(int type){
        ...
        mRecyclerView.setAdapter(mPdfViewAdapter);
        MySharedPreferences.setPrefViewRecent(this,type==0);
    }

    void setupGUI(){
        switch (typeSort){
            case 0:
                Collections.sort(pdfDocmnts,PDFDoc.sortOpendTime);
                break;
            case 1:
